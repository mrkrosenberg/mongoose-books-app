...
//create author and books documents

//creates list of authors that will give each author an id that can be referenced for the books_list object
var authors_list = [
  {
    name: "Harper Lee",
    alive: false
...
//creates the book list that will take id's for each author once the author_list is created
var books_list = [
  {
...
//removes the authors so it can be dynamically repopulated with new data
